...
namespace Zetcil
{
    ...
    public class VarConfig : MonoBehaviour
    {
        ...
        public void InitializeDataSession()
        {
            ...
            dataAsset = (TextAsset)Resources.Load(DataSessionDirectory + "/Default.CurrentLock", typeof(TextAsset));
            if (!IsSessionExists(DataSessionDirectory, "Default.CurrentLock"))
            {
                SaveDataSessionFile("Default.CurrentLock", dataAsset.ToString());
            }
